        ...
        return (
          <Flex
            ...
            style={{
              width: '100%',
              height: 28,
              borderBottom: index === items.length - 1 ? 'none' : '1px solid var(--base-stroke-color-base-stroke-20, #E2E5F0)'
            }}
          >
            <div
              style={{
            ...
            {item?.renderValue ? (
              <div
                style={{ flex: 1, paddingLeft: 12, paddingRight: 12, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}
              >
              ...
              >
                {typeof item.value === 'number' ? item.value : item.value ? item.value : '-'}
              </Typography>
            )}
          </Flex>
        );
